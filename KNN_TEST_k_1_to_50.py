...
saveout = sys.stdout
save = open("KNN_TEST_10folds_k_from_1_to_50.txt", 'w')   #saving in a file the output of print
sys.stdout = save

accuracy_summary = []
for k_neighbours in range(1,50):
    ...
    print("KNN - K-folds Test Prediction, k_neighbours = "+str(k_neighbours)+", accuracy:", round(accuracy, 3))
